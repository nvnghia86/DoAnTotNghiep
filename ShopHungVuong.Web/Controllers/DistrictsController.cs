...
namespace ShopHungVuong.Web.Controllers
{
    public class DistrictsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DistrictId,ProvinceId,DistrictName,DistrictType")] District district)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DistrictId,ProvinceId,DistrictName,DistrictType")] District district)
        {
            if (ModelState.IsValid)
            {
